public class Circle implements Shape {
	...
	*/
	...
	public static Circle fromPoints(Point p1, Point p2, Point p3) {
		...
		Point[] circlePoints = {p1, p2, p3};
		Point centerPoint = Point.centerOfMass(circlePoints);
		double circleRad = Point.distance(centerPoint, p1);
		return new Circle(centerPoint, circleRad);
