...
public class Main {
    ...
    //Practice: Make a static method in Main that takes an array of LibraryItem objects and outputs an ArrayList of LibraryItem objects with all of the available items from the input array.
    ...
    public static void main(String[] args) {
        ...
        //practice: Write a non-static method that calculates and returns the angle in degrees between a point and the positive x axis.
        Point testPoint = new Point(-1, -1);
        System.out.println("Angle: " + testPoint.angle(testPoint));

        //pratice: Write a static method for the Point class that takes as an argument an array of Point objects, and returns the center of mass, as a Point.
